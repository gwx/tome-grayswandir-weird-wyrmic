...
if game.config.settings.tome.grayswandir_weird_wyrmic_original_drakes == false then
	for i = #loading_list, 1, -1 do
		...
		if e.type == 'dragon' and e.subtype == 'fire' then
...
if game.config.settings.tome.grayswandir_weird_wyrmic_weird_drakes == true then
	...
	newEntity{
		define_as = 'BASE_NPC_WEIRD_FIRE_DRAKE',
	...
	newEntity {
		...
		name = 'weird fire drake hatchling', color = colors.RED, display = 'd',
		image = 'npc/dragon_fire_fire_drake_hatchling.png',
		...
		combat = {
			...
			--apr = 25,
			dammod = {str = 1.1,},},
		--on_melee_hit = {FIRE = mbonus(7, 2),},
		on_melee_hit = {FIRE = mbonus(4, 1),},
		make_escort = {
			{type = 'dragon', name = 'weird fire drake hatchling',
	...
	newEntity {
		base = 'BASE_NPC_WEIRD_FIRE_DRAKE',
		name = 'weird fire drake', color = colors.RED, display = 'D',
		image = 'npc/dragon_fire_fire_drake.png',
		...
		combat = {
			...
			atk = avg(25, 70),
			dammod = {str = 1.1,},},
		on_melee_hit = {FIRE = mbonus(15, 5)},
		stats_per_level = 4,
		lite = 1,

		make_escort = {
			{type = 'dragon', name = 'weird fire drake hatchling', number = 1,},},
		...
		resolvers.talents {
			...
			T_WEIRD_FAN_THE_FLAMES = {base = 1, every = 7, max = 7,},
			T_WEIRD_FIRE_CLAW = {base = 2, every = 7, max = 9,},
			T_WEIRD_FIRE_AURA = {base = 1, every = 7, max = 9,},
			T_WEIRD_DRACONIC_CLAW = {base = 2, every = 9, max = 7,},
			T_WEIRD_DRACONIC_AURA = {base = 1, every = 9, max = 7,},},}

	newEntity{
		base = 'BASE_NPC_WEIRD_FIRE_DRAKE',
		name = 'weird fire wyrm', color = colors.LIGHT_RED, display = 'D',
		desc = [[An old and powerful fire drake, armed with deadly breath and nasty claws.]],
		resolvers.nice_tile {
			image = 'invis.png',
			add_mos = {{image = 'npc/dragon_fire_fire_wyrm.png', display_h = 2, display_y= - 1,},},},
		level_range = {25, nil,}, exp_worth = 1,
		rarity = 5,
		rank = 3,
		max_life = 190,
		combat_armor = 30, combat_def = 0,
		on_melee_hit = {FIRE = mbonus(25, 10),},
		combat = {
		...
		make_escort = {
			{type = 'dragon', name = 'weird fire drake', number = 1,},
			{type = 'dragon', name = 'weird fire drake', number = 1, no_subescort = true},},
		...
		resolvers.talents {
			...
			T_WEIRD_FAN_THE_FLAMES = {base = 2, every = 7, max = 9,},
			T_WEIRD_FOCUSED_FURY = {base = 1, every = 7, max = 7,},
